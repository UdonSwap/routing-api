...
const MODE_UNIVERSAL_ROUTER_ADDRESS = UNIVERSAL_ROUTER_ADDRESS(ChainId.MODE)
...
const UniversalRouterInputFactory = universalRouterInputFactory.define(() => ({
  ...
  currencyIn: new Token(ChainId.MODE, '0x0000000000000000000000000000000000000001', 18, 'FOO', 'Foo'),
  currencyOut: new Token(ChainId.MODE, '0x0000000000000000000000000000000000000002', 18, 'BAR', 'Bar'),
...
describe('SwapOptionsFactory - Universal Router', () => {
  ...
  it('Populates the permit data if all permit fields are provided', () => {
    ...
    expect(swapOptions!.inputTokenPermit!).toEqual({
      ...
      spender: MODE_UNIVERSAL_ROUTER_ADDRESS,
