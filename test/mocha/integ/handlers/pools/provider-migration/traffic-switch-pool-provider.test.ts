...
import { CachingV3PoolProvider, MetricLoggerUnit, NodeJSCache } from 'udonswap-smart-order-router-v3'
...
import {
  DAI_MODE as DAI,
  USDC_MODE as USDC,
} from 'udonswap-smart-order-router-v3/build/main/providers/token-provider'
