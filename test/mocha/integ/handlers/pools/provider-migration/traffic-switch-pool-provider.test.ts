...
import { CachingV3PoolProvider, MetricLoggerUnit, NodeJSCache } from 'u-smart-order-router-v3'
...
import {
  DAI_MODE as DAI,
  USDC_MODE as USDC,
} from 'u-smart-order-router-v3/build/main/providers/token-provider'
